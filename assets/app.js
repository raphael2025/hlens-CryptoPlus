...
(function () {
  ...
  const I18N = {
    en: {
      ...
      "hero.lede": "A prism splits white light into a spectrum. hlens splits a perpetual market into the people inside it: retail, top traders and on-chain whales, across Binance, Bybit, OKX and Hyperliquid. When they disagree, that is the signal.",
      ...
      "m2.h": "Three kinds of positioning", "m2.p": "Retail = share of accounts net long (Binance, Bybit, OKX). Top traders = Binance top-20% accounts by position. Whales = notional-weighted long share of tracked Hyperliquid wallets. These usually disagree; the gap is the point.",
      ...
      "foot.sources": "Sources: Binance USDⓈ-M, Bybit linear, OKX swap, Hyperliquid info API and leaderboard.",
      "foot.refresh": "Refreshed every {n} min by GitHub Actions.",
      // dynamic
      "f.retail": "Retail long share", "f.retail.s": "accounts net long · Binance/Bybit/OKX",
      "f.top": "Top-trader long share", "f.top.s": "Binance top 20% by position",
      "f.taker": "Taker buy share", "f.taker.s": "aggressive buy vol ÷ total · 1h",
      "f.whale": "Whale long share", "f.whale.s": "Hyperliquid, notional-weighted",
      "f.funding": "Funding (8h)", "f.funding.s": "OI-weighted across 4 venues",
      "f.oi": "Open interest", "f.oi.s": "sum of 4 venues, USD",
    ...
    zh: {
      ...
      "join.cta": "加入社群",
      "hero.h1": "一个币，所有角度。",
      "hero.lede": "棱镜把一束白光分解成光谱。hlens 把一个合约市场分解成里面的人：散户、大账户、链上大户，横跨 Binance、Bybit、OKX 和 Hyperliquid。当他们意见相左，那就是信号。",
      ...
      "m2.h": "三种持仓视角", "m2.p": "散户 = 净多账户占比（Binance、Bybit、OKX）。大账户 = Binance 按仓位排名前 20% 的账户。大户 = 追踪的 Hyperliquid 钱包按名义价值加权的多头占比。三者经常不一致，差距本身就是信息。",
      ...
      "foot.sources": "数据源：Binance U 本位、Bybit 线性、OKX 永续、Hyperliquid info 接口与排行榜。",
      "foot.refresh": "由 GitHub Actions 每 {n} 分钟刷新。",
      "f.retail": "散户多头占比", "f.retail.s": "净多账户占比 · Binance/Bybit/OKX",
      "f.top": "大账户多头占比", "f.top.s": "Binance 持仓前 20% 账户",
      "f.taker": "主动买入占比", "f.taker.s": "主动买量 ÷ 总量 · 1 小时",
      "f.whale": "大户多头占比", "f.whale.s": "Hyperliquid，名义价值加权",
      "f.funding": "资金费率（8h）", "f.funding.s": "四所按持仓量加权",
      "f.oi": "持仓量", "f.oi.s": "四所合计，美元",
