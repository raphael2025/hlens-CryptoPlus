...
- Read `docs/00-PROJECT.md` (§4 principles, §7 architecture/seams/stack table, §8 milestones), `docs/01-FEATURES.md` (pages, components, i18n, four states per component), and `docs/02-ARCHITECTURE.md` (modules, data model, export) before building anything.
