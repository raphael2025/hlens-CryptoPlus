...
- Read `docs/00-PROJECT.md` (§4 principles, §7 architecture/seams/stack table, §8 milestones), `docs/02-ARCHITECTURE.md` (modules, data model, processes), and `docs/06-DATA-SOURCES.md` first; your job is to confirm or correct the latter's "未验证" items with evidence.
